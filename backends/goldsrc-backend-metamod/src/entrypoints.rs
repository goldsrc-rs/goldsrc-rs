...
pub unsafe extern "C" fn GetEntityAPI2(
    ...
    catch_ffi_panic("GetEntityAPI2", 0, || {
        ...
        if unsafe {
            goldsrc_core::api_registry::ApiRegistry::install(
                dll_table,
                interface_version,
                goldsrc_core::api_registry::HookPhase::Pre,
                true,
            )
        } {
            1
    ...
    catch_ffi_panic("GetEntityAPI2_Post", 0, || {
        ...
        if unsafe {
            goldsrc_core::api_registry::ApiRegistry::install(
                dll_table,
                interface_version,
                goldsrc_core::api_registry::HookPhase::Post,
                true,
            )
        } {
            1
...
unsafe extern "C" fn hook_reg_user_msg_post(
    ...
    catch_ffi_panic("hook_reg_user_msg_post", 0, || {
        ...
        {
            goldsrc_core::backend::register_user_msg_id(c_str, msg_id);
        }
        msg_id
    })
}
